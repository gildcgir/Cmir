export const API = localStorage.getItem("smir_api") || "http://localhost:8090";

export function getToken() {
  return localStorage.getItem("smir_token") || "";
}

export function setToken(t) {
  if (t) localStorage.setItem("smir_token", t);
  else localStorage.removeItem("smir_token");
}
