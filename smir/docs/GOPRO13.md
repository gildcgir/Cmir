# GoPro HERO13 Black — тестирование со Smir

Да, **GoPro 13 подойдёт** для lab-тестов Smir: это отличный источник широкоугольного live-видео с хорошей стабилизацией. Smir не подключается к камере напрямую — поток идёт через **ingest** (MediaMTX), затем face-worker и web.

## Что поддерживает HERO13 (практично для нас)

| Способ | Для Smir | Сложность |
|--------|----------|-----------|
...
## Шаг 4 — зарегистрировать камеру в Smir
